...
def main():
    ...
    while (exiter == False):
        ...
        print("40: Furthur")
        print("41: Grateful Shred")
        print("42: Garcia Peoples")
        print("43: Hot Buttered Rum")
        print("44: Jefferson Starship")
        print("45: Grace Potter and the Nocturnals")
        print("46: The Travelin' McCourys")
        print("47: Bob Weir")
        print("48: the werks")
        #groups to add:
        ...
        if g == 1:
            ...
            name = "furthur"
            search_results = search_items('collection:Furthur')
            print(search_results.num_found)
            for result in search_results:
                queryResults.write(result['identifier'] + '\n')
                shows.append(result['identifier'])
            ...
            name = "gratefulshred"
            search_results = search_items('collection:GratefulShred')
            print(search_results.num_found)
            for result in search_results:
                queryResults.write(result['identifier'] + '\n')
                shows.append(result['identifier'])
            ...
            name = "garciapeoples"
            search_results = search_items('collection:GarciaPeoples')
            print(search_results.num_found)
            for result in search_results:
                queryResults.write(result['identifier'] + '\n')
                shows.append(result['identifier'])
            ...
            name = "hotbutteredrum"
            search_results = search_items('collection:HotButteredRum')
            print(search_results.num_found)
            for result in search_results:
                queryResults.write(result['identifier'] + '\n')
                shows.append(result['identifier'])
        elif g == 44:
            name = "jeffersonstarship"
            search_results = search_items('collection:JeffersonStarship')
            print(search_results.num_found)
            for result in search_results:
                queryResults.write(result['identifier'] + '\n')
                shows.append(result['identifier'])
            ...
            name = "gracepotter"
            search_results = search_items('collection:GracePotterandtheNocturnals')
            print(search_results.num_found)
            for result in search_results:
                queryResults.write(result['identifier'] + '\n')
                shows.append(result['identifier'])
        elif g == 46:
            name = "travelinmccourys"
            search_results = search_items('collection:TheTravelinMcCourys')
            print(search_results.num_found)
            for result in search_results:
                queryResults.write(result['identifier'] + '\n')
                shows.append(result['identifier'])
            ...
            name = "bobweir"
            search_results = search_items('collection:BobWeir')
            print(search_results.num_found)
            for result in search_results:
                queryResults.write(result['identifier'] + '\n')
                shows.append(result['identifier'])
            ...
            name = "thewerks"
            search_results = search_items('collection:thewerks')
            print(search_results.num_found)
            for result in search_results:
                queryResults.write(result['identifier'] + '\n')
                shows.append(result['identifier'])
